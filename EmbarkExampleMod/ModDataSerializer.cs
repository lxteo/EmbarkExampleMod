...
namespace EmbarkExampleMod {
    ...
    public class ModDataSerializer : IModDataSerializer
    {
        ...
        /// In this example we use protobuf (https://github.com/protocolbuffers/protobuf/tree/master/csharp), which Embark uses as well, but you may serialize and deserialize data however you like.
        ...
        /// </summary>
        /// <param name="saveFile">The file which Embark makes for your mod</param>
        ...
        /// </summary>
        /// <param name="saveFile">The file which Embark makes for your mod, method will not be called if no file is found</param>
